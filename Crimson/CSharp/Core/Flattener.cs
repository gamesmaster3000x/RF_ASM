...
namespace Crimson.CSharp.Core
{
    public class Flattener
    {
        ...
        internal BasicProgram Flatten(Compilation compilation)
        {
            ...
            program.Statements.Add(new CommentBStatement("This CrimsonBasic program was automatically generated by the Crimson compiler."));
            program.Statements.Add(new CommentBStatement("Crimson version " + Crimson.VERSION));
            program.Statements.Add(new CommentBStatement("CrimsonBasic version " + CrimsonBasic.CSharp.Core.CrimsonBasic.VERSION));
            program.Statements.Add(new CommentBStatement("Copyright (c) 2022 GenElectrovise https://github.com/GenElectrovise and GamesMaster3000X https://github.com/gamesmaster3000x"));
            program.Statements.Add(new CommentBStatement("In case of problems with this compiler, register an issue or contact the authors at https://github.com/gamesmaster3000x/RF_ASM"));
            program.Statements.Add(new CommentBStatement(""));

            // Add global variables
            program.Statements.Add(new CommentBStatement(""));
            program.Statements.Add(new CommentBStatement("============================== Global Variables =============================="));
            ...
            // Add structures
            program.Statements.Add(new CommentBStatement(""));
            program.Statements.Add(new CommentBStatement("(Structures shouldn't be a part of CB)"));
            program.Statements.Add(new CommentBStatement("============================== Structures =============================="));
            ...
            program.Statements.Add(new CommentBStatement(""));
            program.Statements.Add(new CommentBStatement("============================== Entry Function =============================="));
            ...
            program.Statements.Add(new CommentBStatement(""));
            program.Statements.Add(new CommentBStatement("============================== Functions =============================="));
