...
{
    internal class RFASMFlattener : IFlattener
    {
        ...
        public AbstractAssemblyProgram Flatten (Compilation compilation)
        {
            ...
            program.Add(new RFASMComment("This CrimsonBasic program was automatically generated by the Crimson compiler."));
            program.Add(new RFASMComment("Copyright (c) 2022-2023 GenElectrovise https://github.com/GenElectrovise and GamesMaster3000X https://github.com/gamesmaster3000x"));
            program.Add(new RFASMComment("Crimson version " + Core.Crimson.VERSION));
            program.Add(new RFASMComment("Crimson, CrimsonBasic and RedFoxAssembly are parts of GamesMaster3000X's RedFoxVirtualMachine."));
            program.Add(new RFASMComment("The main repository for this project can be found at: https://github.com/gamesmaster3000x/RF_ASM"));
            program.Add(new RFASMComment("Crimson, CrimsonBasic and RedFoxAssembly were implemented by me, GenElectrovise."));
            program.Add(new RFASMComment("My development fork of the project can be found at: https://github.com/GenElectrovise/RF_ASM"));
            program.Add(new RFASMComment(""));
            ...
            // Add structures
            program.Add(new RFASMComment(""));
            program.Add(new RFASMComment("(Structures shouldn't be a part of CB)"));
            ...
            program.Add(new RFASMComment(""));
            program.Add(new RFASMComment("============================== Functions =============================="));
