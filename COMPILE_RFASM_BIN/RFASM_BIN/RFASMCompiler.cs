    ...
    class RFASMCompiler
    {
        ...
        private void Start(string[] args)
        {
            ...
            if (USE_AUTOWIRED_ARGUMENTS)
            {
                ...
                args = new string[] { "-INPUT_PATH", "test_dw4.rfp", "-DATA_WIDTH", "1", "-RANDOM_ARG", "-OTHER_RANDOM_ARG", " ", "CONFUSION", "-" };
            }
            ...
            Utils.DisplayHexDump(compiledBytes.ToArray());
        ...
        private void CheckSyntax(List<IToken> tokens)
        {
            for(int i = 0; i < tokens.Count; i++)
            {
                ...
                if (!token.HasCorrectSyntax(following))
                {
