...
| Instruction | Arguments | Hex value | Description
| - |
| HLT | N/A |  00 | Immediately stop the execution of instructions. Next instruction will not be read.
...
| ADD | N/A | 03 | Add the values in registers 1 and 2, and store the result in 0.
| SUB | N/A | 04 | Subtract the value of register 2 from 1 and store the result in 0.
| LSL | N/A | 05 | Shift the value of register 1 to the left (x2) and store the result in 0.
| LSR | N/A | 06 | Shift the value of register 1 to the right (/2) and store the result in 0.
...
| RTN | N/A | 0E |  Jump to the last memory address in stack, and remove it.
